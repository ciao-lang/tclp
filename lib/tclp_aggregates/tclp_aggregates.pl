...
:- doc(table/1,"It declares a tabled / entailment-based aggregated predicate.").

:- doc(join/1,"It declares a tabled / join-based aggregated predicate.").


:- include(library(tclp_aggregates/aggregate_rt)).
